...
import com.project.www.marketing.controller.MediaController;
...
public class MediaController {
    ...
    // ✅ Upload
    @PostMapping("/upload")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('TENANT_ADMIN') or hasAuthority('MARKETING_MEDIA_UPLOAD')")
    ...
    // ✅ Download
    @GetMapping("/{fileName:.+}")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('TENANT_ADMIN') or hasAuthority('MARKETING_MEDIA_VIEW')")
