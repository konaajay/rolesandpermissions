...
public class TemplateDefinitionService {
    ...
    private final com.project.www.accessmanagement.repository.UserRepository userRepository;
    private final com.project.www.tenant.repository.CompanyProfileRepository companyProfileRepository;
    ...
    public byte[] generateDocumentPdf(Long id, Long userId) throws Exception {
        Long tenantId = TenantContext.getCurrentTenant();
        TemplateDefinition t = getTemplateById(id);
        com.project.www.accessmanagement.entity.User user = userRepository.findByIdAndTenantId(userId, tenantId)
        ...
        com.project.www.tenant.entity.CompanyProfile company =
    ...
    private String buildAddress(com.project.www.tenant.entity.CompanyProfile c) {
