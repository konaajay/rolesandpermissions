...
public class Coupon {
    ...
    public List<CouponCourse> getCouponCourses() { return couponCourses; }
    public void setCouponCourses(List<CouponCourse> couponCourses) { this.couponCourses = couponCourses; }
}
