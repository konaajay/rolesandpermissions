...
public class SecurityService {
    ...
    private Set<Long> getScopedUserIdsInternal(User requester, Long managerId, Long teamLeaderId) {
        ...
        // Use provided managerId if requester is ADMIN, otherwise use requester's
        // context
    ...
    public boolean isTeamLeader(User user) {
        String role = getRole(user);
        return role.contains("TEAMLEADER") || role.contains("TL") || role.contains("TEAMLEAD")
                || role.contains("TEAMLEAS");
    }
