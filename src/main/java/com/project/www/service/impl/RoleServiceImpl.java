...
import com.project.www.dto.RoleHierarchyResponse;
import com.project.www.entity.Permission;
import com.project.www.entity.Role;
import com.project.www.entity.RoleHierarchy;
import com.project.www.repository.PermissionRepository;
import com.project.www.repository.RoleHierarchyRepository;
import com.project.www.repository.RoleRepository;
import com.project.www.service.RoleService;
...
import com.project.www.dto.RoleResponse;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    @Transactional
    public void mapPermissions(Long roleId, com.project.www.dto.MapPermissionsRequest request) {
        Long tenantId = TenantContext.getCurrentTenant();
        if (tenantId == null) {
            throw new RuntimeException("No tenant context found");
        }
